...
public class A_for {
	...
	public void testForExample1() {
		...
		System.out.println("10 번째 학생의 이름을 입력해주세요 : ");
...
//		System.out.println("sum : " + sum);
	...
	public void testForExample3() {
		...
		/* 5 ~ 10 사이의 난수를 발생시켜서 1부터 발생한 난수까지의 합계를 구하시오 */
	...
	public void testForExample4() {
		...
		/* 숫자 두 개를 입력 받아 작은 수 에서 큰 수까지 합계를 구하세요
		 * 단, 두 숫자는 같은 숫자를 입력하지 않는다는 가정으로 하며, 처음 입력하는 숫자가 작은 값인지 큰 값인지는 모르는 상황이다.
		 * */
